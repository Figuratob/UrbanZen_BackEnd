...
describe('Service Tests', () => {
  describe('Studio Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(StudioService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Studio(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Studio', async () => {
        const returnedFromService = Object.assign(
          {
            about: 'BBBBBB',
            street: 'BBBBBB',
