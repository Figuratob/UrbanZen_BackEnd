...
public class BookingResourceIT {
    ...
    private static final Instant SMALLER_RESERVATION_DATE = Instant.ofEpochMilli(-1L);
    ...
    private static final Instant SMALLER_CANCEL_DATE = Instant.ofEpochMilli(-1L);
    ...
    public void createBooking() throws Exception {
        ...
        assertThat(testBooking.getReservationDate()).isEqualTo(DEFAULT_RESERVATION_DATE);
        assertThat(testBooking.getCancelDate()).isEqualTo(DEFAULT_CANCEL_DATE);
    }
    ...
    @Test
    @Transactional
    public void checkReservationDateIsRequired() throws Exception {
    ...
    public void updateBooking() throws Exception {
        ...
        Booking testBooking = bookingList.get(bookingList.size() - 1);
        assertThat(testBooking.getReservationDate()).isEqualTo(UPDATED_RESERVATION_DATE);
        assertThat(testBooking.getCancelDate()).isEqualTo(UPDATED_CANCEL_DATE);
    }
